  ...
  return (
    <section className="home" id="home">
      ...
      <div className="home-content">
        ...
        >
          <a href="https://github.com/amitkumar0072" target="_blank" rel="noreferrer">
            <FaGithub />
          </a>
          <a href="https://www.linkedin.com/in/amit-kumar-92111b241/" target="_blank" rel="noreferrer">
            <FaLinkedin />
          </a>
          <a href="https://twitter.com/" target="_blank" rel="noreferrer">
            <FaTwitter />
          </a>
          <a href="https://www.instagram.com/amit_thenua11/" target="_blank" rel="noreferrer">
            <FaInstagram />
          </a>
        </motion.div>
