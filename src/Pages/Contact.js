...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch("https://formspree.io/f/mbddokbq", {
        method: "POST",
    ...
    <section className="contact" id="contact" ref={ref}>
      ...
      <div className="contact-container">
        ...
        <div className="contact-info">
          {[
            { icon: <FaEnvelope />, label: "Email", value: "a_kumar1@bt.iitr.ac.in" },
            { icon: <FaPhoneAlt />, label: "Phone", value: "+91 9119063442" },
            { icon: <FaLinkedin />, label: "LinkedIn", value: "https://www.linkedin.com/in/amit-kumar-92111b241/" },
            { icon: <FaGithub />, label: "GitHub", value: "github.com/amitkumar0072" },
            { icon: <FaMapMarkerAlt />, label: "Location", value: "Gurugram, India" },
          ].map((item, i) => (
            <motion.div
              key={i}
